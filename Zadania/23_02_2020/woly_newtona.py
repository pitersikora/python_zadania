...
def input_get():
    ...
    try:
        ...
        print exc
        print "\033[91mPodaj liczbe morgow oraz czas w parametrach startowych programu !!!\033[92m"
        exit(1)
...
def main():
    ...
    print "Jedna krowa zjada 2 jednostki trawy tygodniowo\n"
    calc =int(math.ceil(((field * 4.0) + (field * grow_time)) / (grow_time * 2.0)))
    print "Do pelnego wypasu potrzeba krow w ilosci: \033[95m%d\033[00m" % calc
    print_cow(calc)
